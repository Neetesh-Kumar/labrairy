...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
	...
	<div class="row" style="margin-right:0px;">
		...
		<div class="col-md-8">
		<h1 style="text-align:center; color:white;" class="bg-dark">Manage All Author </h1>
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<a class="btn btn-primary" href="edit_author.php?aid=<?php echo $row['author_id'];?>">Edit</a>
