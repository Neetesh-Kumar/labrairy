...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
	...
	<div class="row" style="margin-right:0px;">
		...
		<div class="col-md-4">
		<h1 style="text-align:center; color:white;" class="bg-dark">Edit Author Name</h1>
			<form action="" method="post">
				<div class="form-group">
					<label>Author Name:</label>
					<input type="text" name="autor_name" value="<?php echo $autor_name;?>" class="form-control" required="">
				</div>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update authors set autor_name = '$_POST[autor_name]' where author_id = $_GET[aid]";
		$query_run = mysqli_query($connection,$query);
