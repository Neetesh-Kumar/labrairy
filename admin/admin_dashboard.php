		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="image/user.png" width="30px"> My Profile</a>
...
<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of total users: <span class="badge badge-danger"><?php echo get_user_count(); ?></span></p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of availbale books:  <span class="badge badge-primary"><?php echo get_book_count(); ?></span> </p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of book's category: <span class="badge badge-info"><?php echo get_category_count(); ?></span> </p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of availbale authors: <span class="badge badge-primary"><?php echo get_author_count(); ?></span> </p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. Issued Books: <span class="badge badge-success"><?php echo get_issued_book_count(); ?></span> </p>
