...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
	...
	<div class="row"  style="margin-right:0px;">
		<div class="col-md-4">
		<h1 style="text-align:center; color:white;" class="bg-dark">All Category</h1>
		...
		<div class="col-md-4">
		<h1 style="text-align:center; color:white;" class="bg-dark">Add New Book </h1>
		...
		<div class="col-md-4">
		<h1 style="text-align:center; color:white;" class="bg-dark">All Author </h1>
			<table class="table table-bordered table-hover">
				<thead>
					<tr>
						<th>Author ID</th>
